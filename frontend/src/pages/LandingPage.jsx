...
const LandingPage = () => {
    ...
    return (
        <>
            <div className='w-full min-h-full bg-[#fffcef] pb-20'>
                <div className='w-[500px] h-[500px] bg-amber-200/20 blur-[65px] absolute top-0 left-0' />
                <div className='container mx-auto px-20 pt-6 pb-[200px] relative z-10'>
                    ...
                    <div className='flex flex-col md:flex-row items-center'>
                        ...
                        <div className='w-full md:w-1/2'>
                            <p className='text-[17px] text-gray-900 mr-0 md:mr-20 mb-8'>
            ...
            <div className='w-full min-h-full relative z-10'>
                <div>
                    <section className='flex items-center justify-center -mt-36'>
                        <img className='w-[80vw] rounded-lg' 
            ...
            <div className='w-full min-h-full bg-[#fffcef] mt-10'>
                <div className='container mx-auto px-4 pt-10 pb-20'>
                    <section className='mt-5'>
                        <h2 className='text-4xl font-semibold text-center mb-12'>Features That Make You Shine</h2>
            ...
            <div className='text-sm bg-gray-50 text-secondary text-center p-5 mt-5 '>
                Copyright 2025 © PrepIQ. All Rights Reserved.
            </div>
